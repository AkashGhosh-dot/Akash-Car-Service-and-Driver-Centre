...
export function ServicesGrid({
  ...
  return (
    ...
    >
      ...
      >
        <span
          className="select-none whitespace-nowrap font-heading font-bold tracking-widest text-slate-900"
          style={{ fontSize: "clamp(72px, 14vw, 210px)", opacity: 0.025, lineHeight: 1.3 }}
        >
          SERVICES
        </span>
      </div>
