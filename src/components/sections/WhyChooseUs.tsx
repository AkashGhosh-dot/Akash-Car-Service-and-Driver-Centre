import { Clock, MapPin, Car, Shield, CheckCircle, type LucideIcon } from "lucide-react";
...
const USP_ITEMS: USPItem[] = [
  ...
  },
  {
    ...
    description:
      "Cars, buses, travellers, tempos, trucks, and wedding fleets under one roof.",
  },
  {
    icon: Shield,
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl font-body text-base text-gray-500">
            Thousands of customers across Kolkata trust us for reliable, on-time transport — every
            single day.
          </p>
        </div>
